...
export default function DiaPage() {
  ...
  // Buscar dados do dia (incluindo fases 3 e 4)
  let dadosDia = getDadosDia(diaNumero);
  
  // Se não encontrou nos dados principais, buscar nas fases 3 e 4
  if (!dadosDia) {
    const chave = `dia${diaNumero}` as keyof typeof dadosFase3e4;
    dadosDia = dadosFase3e4[chave];
  }
    ...
    return (
      <div className="min-h-screen bg-[#F2F4F7] flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/trilhas/condromalaciа" className="text-[#2F66F2] hover:underline">
        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-[#2F66F2]">{diaNumero}/30</div>
          ...
          <div className="space-y-3">
            ...
            {diaNumero < 30 && (
              <button
                onClick={() => router.push(`/trilhas/condromalaciа/dia/${diaNumero + 1}`)}
    ...
    <div className="min-h-screen bg-[#F2F4F7] pb-6">
      ...
      <header className="bg-[#2F66F2] text-white pt-12 pb-8 px-6">
        <div className="max-w-md mx-auto">
          <Link href="/trilhas/condromalaciа" className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-4">
