...
export default function DiaVoltaTreinosPage() {
  const router = useRouter();
  const params = useParams();
  const dia = parseInt(params.dia as string);
  
  const [etapaAtual, setEtapaAtual] = useState(0);
  const marcarDiaConcluido = useAppStore((state) => state.marcarDiaConcluidoVoltaTreinos);

  const dadosDia = dadosTrilhaVoltaTreinos.dias[dia];

  useEffect(() => {
    if (!dadosDia) {
      router.push('/trilhas/volta-treinos');
    }
  }, [dadosDia, router]);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full">
          <button
            onClick={() => router.push('/trilhas/volta-treinos')}
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center text-4xl mx-auto mb-6">
              💪
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-6">
              <p className="text-orange-800 text-sm leading-relaxed">
                <strong>Fase {dadosDia.fase}:</strong> {dadosTrilhaVoltaTreinos.fases[dadosDia.fase - 1].nome}
              </p>
            </div>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center justify-center gap-2 text-gray-700">
                ...
                <span>{dadosDia.exercicios.length} exercícios terapêuticos</span>
              </div>
              <div className="flex items-center justify-center gap-2 text-gray-700">
                <CheckCircle2 className="w-5 h-5 text-orange-500" />
              ...
              <div className="flex items-center justify-center gap-2 text-gray-700">
                <CheckCircle2 className="w-5 h-5 text-orange-500" />
                <span>Preparação para treinos</span>
              </div>
            </div>

            <button
              onClick={proximaEtapa}
              className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:opacity-90 text-white font-semibold py-4 px-6 rounded-xl transition-all shadow-lg"
            >
              Começar dia {dia}
            </button>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 pb-24">
        <div className="max-w-2xl mx-auto px-6 py-8">
          ...
          <div className="mb-6">
            ...
            <div className="bg-orange-100 text-orange-800 text-sm font-semibold px-4 py-2 rounded-lg inline-block mb-4">
            ...
            <p className="text-orange-600 font-medium mb-4">{exercicio.subtitulo}</p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center p-6">
        <div className="max-w-2xl w-full">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6">
              📚
            </div>
            ...
            <button
              onClick={proximaEtapa}
              className="w-full mt-8 bg-gradient-to-r from-orange-500 to-red-500 hover:opacity-90 text-white font-semibold py-4 px-6 rounded-xl transition-all shadow-lg"
            >
              Continuar
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          <div className="w-24 h-24 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center text-5xl mx-auto mb-6">
            🎉
          </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-8">
            <p className="text-green-800 leading-relaxed">
              Você está preparando seu joelho de forma segura para retornar aos treinos. Continue assim e os resultados virão!
            </p>
          </div>
