...
export default function DiaEscadasPage() {
  ...
  const marcarDiaConcluido = useAppStore((state) => state.marcarDiaConcluidoEscadas);

  const dadosDia = dadosTrilhaEscadas.dias[dia as keyof typeof dadosTrilhaEscadas.dias];
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <button
            onClick={() => router.push('/trilhas/dor-ao-subir-e-descer-escadas')}
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
        <div className="max-w-md mx-auto px-6 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center text-4xl mx-auto mb-6">
              🪜
            </div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-4 px-6 rounded-xl transition-all flex items-center justify-center gap-2"
            >
        ...
        <div className="max-w-md mx-auto px-6 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-orange-600 font-medium mb-6">{exercicio.subtitulo}</p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 pb-24">
        <div className="max-w-md mx-auto px-6 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6">
              📚
            </div>
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-8">
            <p className="text-green-800 leading-relaxed">
              Mais um passo na sua jornada para subir e descer escadas sem dor. Continue assim!
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            {dia < dadosTrilhaEscadas.totalDias && (
              <button
                onClick={() => router.push(`/trilhas/dor-ao-subir-e-descer-escadas/dia/${dia + 1}`)}
                className="w-full bg-orange-100 hover:bg-orange-200 text-orange-700 font-semibold py-3 px-6 rounded-xl transition-colors"
              >
                Ir para o Dia {dia + 1}
              </button>
            )}
